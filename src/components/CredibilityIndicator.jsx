...
function getScoreBand(score) {
  if (score >= 90) return { ring: 'ring-emerald-500/40', text: 'text-emerald-400', dot: 'bg-emerald-400' };
  if (score >= 70) return { ring: 'ring-cyan-500/40', text: 'text-cyan-400', dot: 'bg-cyan-400' };
  if (score >= 50) return { ring: 'ring-amber-500/40', text: 'text-amber-400', dot: 'bg-amber-400' };
  return { ring: 'ring-red-500/40', text: 'text-red-400', dot: 'bg-red-400' };
}
...
function CredibilityIndicator({ credibility }) {
  ...
  return (
    <span
      ...
      aria-label={`Credibility score: ${displayValue} out of 100`}
    >
